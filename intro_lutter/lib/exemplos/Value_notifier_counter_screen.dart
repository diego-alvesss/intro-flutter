...
class ValueNotifierCounterScreen extends StatefulWidget {
  const ValueNotifierCounterScreen({super.key});

  @override
  State<ValueNotifierCounterScreen> createState() => _ValueNotifierCounterScreenState();
}

class _ValueNotifierCounterScreenState extends State<ValueNotifierCounterScreen> {
  final ValueNotifier<int> _counter = ValueNotifier<int>(0);
  final ValueNotifier<String> _message = ValueNotifier<String>('clique no botão');
  ...
  void _resetCounter() {
    _counter.value = 0;
    _message.value = 'Resetar Contador ';
